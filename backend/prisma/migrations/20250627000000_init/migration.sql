...
CREATE TABLE `meal_plans` (
    ...
    UNIQUE INDEX `meal_plans_plan_id_key`(`plan_id`),
    INDEX `idx_meal_plans_plan_id`(`plan_id`),
...
CREATE TABLE `menus` (
    ...
    INDEX `idx_menus_meal_plan_id`(`meal_plan_id`),
...
CREATE TABLE `testimonials` (
    ...
    INDEX `idx_testimonials_subscription_id`(`subscription_id`),
    UNIQUE INDEX `uk_testimonials_user_subscription`(`user_id`, `subscription_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `delivery_logs` (
    ...
    INDEX `idx_delivery_logs_subscription`(`subscription_id`),
    INDEX `idx_delivery_logs_date`(`delivery_date`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

ALTER TABLE `menus` ADD CONSTRAINT `menus_meal_plan_id_fkey` FOREIGN KEY (`meal_plan_id`) REFERENCES `meal_plans`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `subscriptions` ADD CONSTRAINT `subscriptions_plan_id_fkey` FOREIGN KEY (`plan_id`) REFERENCES `meal_plans`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE `testimonials` ADD CONSTRAINT `fk_testimonials_user` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `testimonials` ADD CONSTRAINT `fk_testimonials_subscription` FOREIGN KEY (`subscription_id`) REFERENCES `subscriptions`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `delivery_logs` ADD CONSTRAINT `delivery_logs_subscription_id_fkey` FOREIGN KEY (`subscription_id`) REFERENCES `subscriptions`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
